...
//если число справа a больше номиналом текущего числа n следовательно это одно чилсо равное a - n плюсуем к результату, инкремент к счетичку, пропускаем итерацию
//если нет просто плюсуем
//возвращаем получившуюся сумму массива